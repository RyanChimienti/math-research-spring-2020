...
We can think of $\green$ as a ``pseudoinverse" of $\lap$. If our graph $G$ is unbalanced, meaning $\lap$ is invertible, then $\green = \lap^{-1}$. On the other hand, if $G$ is unbalanced, meaning $\lap$ has nullity 1, then $\green = \sum_{i=2}^{n} \frac{1}{\lambda_i} \phi_i \phi_i^*$. 
