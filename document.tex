...
For a simple graph with PageRank matrix $W$, the PageRank vector is defined to be a nonzero vector $x$ satisfying $Wx = x$. Unfortunately, we will have to use a different definition for arbitrary magnetic graphs, since such a vector usually doesn't exist, as the next two facts show.
