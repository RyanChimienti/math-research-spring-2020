...
\cref{traditional PageRank vector exists iff graph has balanced connected component} dashes our hopes of borrowing the nonmagnetic definition of the PageRank vector. But it turns out we \textit{can} borrow the nonmagnetic definition of the ``personalized" PageRank vector.
